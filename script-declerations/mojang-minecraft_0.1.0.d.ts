...
export class MinecraftBlockTypes { public static readonly air = undefined; public static readonly barrier = undefined; public static get(typeName: string): (BlockType | undefined); public static getAllBlockTypes(): BlockType[]; private constructor();};
...
export class MinecraftEffectTypes { public static readonly healthBoost = undefined; public static readonly jumpBoost = undefined; public static readonly levitation = undefined; public static readonly regeneration = undefined; public static readonly saturation = undefined; public static readonly slowFalling = undefined; public static readonly slowness = undefined; public static readonly speed = undefined; private constructor();};
export class MinecraftItemTypes { public static readonly air = undefined; private constructor();};
