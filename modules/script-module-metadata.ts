...
export type MetadataTypeClosure = {
  closure_type: { argument_types: MetadataType[]; return_type: MetadataType };
};
...
export interface MetadataObjectDefinition
  extends MetadataMemberDefinition, MetadataTypedDefinition {}
...
export interface MetadataPropertyMemberDefinition
  extends MetadataMemberDefinition, MetadataTypedDefinition {
...
export interface MetadataFunctionArgumentDefinition
  extends MetadataDefinition, MetadataTypedDefinition {
